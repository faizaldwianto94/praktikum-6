...
![laatihan pertemuan5](foto%20contoh/latihan5.png)
...
![tutu](foto%20contoh/tutu.png) <br>
...
![[alloutput](foto%20contoh/lwrsf.png)
<br>
<br>
<br>
...
[pertemuan 6 lab 1](Lab.1.py)
![](foto%20contoh/lab1.png)
...
![Output END](foto%20contoh/kl.png)
...
![menampilkan hasil END](foto%20contoh/end.png)
<br>
<br>
<br>
### Pertemuan 6 - lab 1-2 
...
![lab1-2](foto%20contoh/lab1-2.png)
...
```
Saat ini saya akan menjelaskan satu persatu syntaxyang diberikan oleh Dosen <br>
1. **String format 1** <br>
Pada syntax / source code stringformat 1 akan menampilkan output berupa 2 outputan. <br>
...
![operasi aritmatika pangkat **](foto%20contoh/kiri.png)<br><br>
...
![output aligmnent](foto%20contoh/jual.png)<br><br>
...
![output aliment](foto%20contoh/rata.png)
<br>
<br>
Hasil string format 2 adalah : <br>
![output algment](foto%20contoh/kanan.png)
<br>
<br>
...
Tugas yang di berikan oleh Dosen adalah seperti gambar dibawah ini atau bisa di temukan dengan link berikut : ([click here](Lab2.py))
``` python
...
![menampilkan lab 2](foto%20contoh/selesai.png)
